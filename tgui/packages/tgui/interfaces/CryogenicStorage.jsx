  ...
  return (
    <Table.Row>
      <Button
        ...
        tooltip={
          highlight ? 'Occupant has high value item(s) in belongings.' : ''
        }
...
export const CryogenicStorage = (props) => {
      ...
      <Window.Content scrollable>
        <Section>
          <NoticeBox textAlign="center">
            You will be held in full liability for any damages to the occupant
            that you eject of your own accord.
          </NoticeBox>
          <Button
            icon="eject"
            color="bad"
